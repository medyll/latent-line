...
export const DEFORUM_TEMPLATE: WorkflowTemplate = {
	...
	workflow: {
		...
		links: [
			{
				id: 'link_1',
				fromNode: 'CheckpointLoaderSimple_1',
				fromOutput: 'MODEL',
				toNode: 'KSampler_5',
				toInput: 'model'
			},
			...
			},
			{
				...
				fromNode: 'CheckpointLoaderSimple_1',
				fromOutput: 'CLIP',
				toNode: 'CLIPTextEncode_3',
				toInput: 'clip'
			},
			{
				id: 'link_4',
				fromNode: 'CLIPTextEncode_2',
				fromOutput: 'CONDITIONING',
				toNode: 'KSampler_5',
				toInput: 'positive'
			},
			{
				id: 'link_5',
				fromNode: 'CLIPTextEncode_3',
				fromOutput: 'CONDITIONING',
				toNode: 'KSampler_5',
				toInput: 'negative'
			},
			{
				id: 'link_6',
				fromNode: 'EmptyLatentImage_4',
				fromOutput: 'LATENT',
				toNode: 'KSampler_5',
				toInput: 'latent_image'
			},
			{
				id: 'link_7',
				fromNode: 'KSampler_5',

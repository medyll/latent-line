...
const exampleStoryModel: Model = {
	...
	assets: {
		characters: [
			{
				...
				outfits: {
					ruins: {
						prompt:
							'mammoth with rusted rebar tangled in tusks, skin covered in white alkaline dust',
						lora: 'wasteland_beast_v2.safetensors'
					}
				}
			},
			{
		...
		environments: {
			dead_city: {
				prompt: 'overgrown financial district, fallen skyscrapers, thick grey fog',
				ref: 'city_ruins.png'
			}
		},
		audio: [
				...
				actors: [
					{
						...
						outfit: 'ruins',
						action:
							'walking heavily through the fog, each step crushing rusted car husks underfoot',
				...
				actors: [
					{
						...
						speech: {
							text: 'The thermal signature is peaking. There is a massive reservoir directly beneath us.',
							mood: 'serene' as Mood
						}
					},
					{
			...
			frame: {
				actors: [
					...
					},
					{
						...
						speech: {
							text: "If Goliath smells it, it's real. Stand back!",
				...
				actors: [
					{
						id: 'mara',
						action:
							'swinging the sledgehammer in a wide arc, smashing the concrete with rhythmic force',
				...
				actors: [
					{
						id: 'jax',
						action:
							'plunging a metal rod into the hole created by Mara, prying a massive slab upward',
						position: { x: 0.4, y: 0.7, scale: 0.9 },
						speech: {
							text: "It's coming up! Lauren, get the sensors ready!",
							mood: 'joyful' as Mood,
							style: 'shout'
						}
					}
			...
			frame: {
				actors: [
					...
					},
					{
						id: 'lauren',
						action:
							'wiping water droplets from her face, laughing as a jet of water sprays the ruins',
						position: { x: 0.7, y: 0.8, scale: 0.8 },
						speech: {
							text: "It's pure... no radiation. We found the source!",
							mood: 'joyful' as Mood
						}
					}
				],
